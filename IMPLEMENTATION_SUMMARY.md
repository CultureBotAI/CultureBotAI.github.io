...
2. **mediaingredientmech.md** - MediaIngredientMech: LLM-Assisted Ingredient Curation
   ...
   - Ontology integration (ChEBI, PubChem, METPO); corrected 2026-09-25 (#150, #190): records map mostly to ChEBI, then MeSH, NCIT, MicrO, FOODON and ENVO; where no term exists, about 230 carry kg-microbe registry ids (about 55 of them placeholders) and about 85 CAS numbers; none map to PubChem or METPO
