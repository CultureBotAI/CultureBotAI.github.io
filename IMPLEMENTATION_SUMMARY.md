...
2. **mediaingredientmech.md** - MediaIngredientMech: LLM-Assisted Ingredient Curation
   ...
   - Ontology integration (ChEBI, PubChem, METPO); corrected 2026-09-25 (#150, #190): records map mostly to ChEBI, then MeSH, CAS, NCIT, MicrO, FOODON and ENVO, with about 230 on kg-microbe registry ids (about 55 of them placeholders), and none to PubChem or METPO
