...
2. **mediaingredientmech.md** - MediaIngredientMech: LLM-Assisted Ingredient Curation
   ...
   - Ontology integration (ChEBI, PubChem, METPO); corrected 2026-09-25 (#150, #190): records map mostly to ChEBI, then MeSH, CAS, NCIT, MicrO, FOODON and ENVO, with about 230 on kg-microbe placeholder ids, and none to PubChem or METPO
