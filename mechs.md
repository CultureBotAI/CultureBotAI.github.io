...
<style>
  ...
  /* The two shading circles sit on top of the coloured disc and must not eat
     its pointer events, or hovering a node would hit the overlay instead of the
     node and the tooltip would never open. They carry no stroke of their own so
     the base circle keeps drawing the single outline. */
  .fleet-stage .node circle.shade { stroke: none; pointer-events: none; }
  /* The two gradients are shaped once in the defs and weighted here, because the
     ...
     HabitatMech is #2b6a4d on light against #4fbf85 on dark -- and a limb shadow
...
<div class="fleet-stats" aria-label="Fleet at a glance">
  ...
  <div><b>449,114</b><span>curated records</span></div>
  <div><b>45</b><span>ontologies &amp; databases cited</span></div>
  <div><b>2,735</b><span>merged PRs</span></div>
    ...
    <svg id="fleet-svg" viewBox="0 0 900 760" role="group" aria-labelledby="fleet-svg-title fleet-svg-desc">
      ...
      <defs>
        ...
        <!-- One light source for the whole ring, up and to the left, so the
             nodes read as lit spheres rather than nine differently lit ones.
...
<div class="mech-cards">
  <article class="mech-card" data-mech="HabitatMech" style="--c: var(--mech-habitatmech)">
    ...
    <div class="num"><b>3,206</b><span>habitat records</span></div>
  ...
  <article class="mech-card" data-mech="CommunityMech" style="--c: var(--mech-communitymech)">
    ...
    <div class="num"><b>364</b><span>community records · KGX export</span></div>
  ...
  <article class="mech-card" data-mech="TraitMech" style="--c: var(--mech-traitmech)">
    ...
    <div class="num"><b>618</b><span>trait records · 374 with causal graphs</span></div>
  ...
  <article class="mech-card" data-mech="CellStructureMech" style="--c: var(--mech-cellstructuremech)">
    ...
    <div class="num"><b>338</b><span>structure records · evidence-backed causal graphs</span></div>
    <p class="prov">0 reviewed · 405 merged PRs</p>
  ...
  <article class="mech-card" data-mech="ProteinTraitsMech" style="--c: var(--mech-proteintraitsmech)">
    ...
    <div class="num"><b>429,291</b><span>protein trait records</span></div>
  ...
  <article class="mech-card" data-mech="AntibioticMech" style="--c: var(--mech-antibioticmech)">
    ...
    <div class="num"><b>2,939</b><span>antimicrobial structures · 91% ChEBI-grounded</span></div>
    <p class="prov">80 reviewed · 152 merged PRs</p>
  ...
  <article class="mech-card" data-mech="MediaIngredientMech" style="--c: var(--mech-mediaingredientmech)">
    ...
    <div class="num"><b>2,957</b><span>ingredient records · 89% mapped</span></div>
  ...
  <article class="mech-card" data-mech="CultureMech" style="--c: var(--mech-culturemech)">
    ...
    <div class="num"><b>6,286</b><span>merged recipes · 15,878 normalized</span></div>
